...
public interface VirtualMachineRequestor {
     ...
     */
    void createNewRequest(Virtual_Machine machine)
     ...
     *
     * @returnA map of users where the value is a map of
     * machine types to quantity created
     */
    Map totalBuildsByUserForDay();
